...
/* Veado Requests */
internal fun sendRequestInstanceInfo(connection: Connection) {
    try {
...
internal fun sendRequestNodeList(connection: Connection) {
    try {
...
internal fun sendChannelListenerEnable(connection: Connection, channel: String = CHANNEL_NODES) {
    try {
...
internal fun sendChannelListenerDisable(connection: Connection, channel: String = CHANNEL_NODES) {
    try {
        //println("Send enable nodes listener")
        connection.send(
            channel = channel, RequestMessage.RequestMessageNodeEventToken(
...
internal fun sendRequestNodeNumberList(
    connection: Connection, channel: String = CHANNEL_NODES, nodeId: String
) {
    try {
        connection.send(
            channel = channel, requestData = RequestMessageNodeEvent(
...
internal fun sendRequestNodeBooleanList(
    connection: Connection, channel: String = CHANNEL_NODES, nodeId: String
) {
    try {
        connection.send(
...
internal fun sendRequestNodeStateGet(connection: Connection, channel: String = CHANNEL_NODES, nodeId: String) {
...
internal fun sendRequestNodeBooleanGet(connection: Connection, channel: String = CHANNEL_NODES, nodeId: String) {
    require(nodeId.isNotBlank()) { "Node ID can't be blank" }
    try {
        connection.send(
            channel = channel, requestData = RequestMessageNodeEvent(
...
internal fun sendRequestMiniAvatarStateList(connection: Connection) {
    try {
...
internal fun sendRequestMiniAvatarStatePeek(connection: Connection) {
    try {
...
internal fun sendRequestMiniPushToTalkMicGet(connection: Connection) {
    try {
 ...
 * * null > Toggle
 */
internal fun sendRequestMiniPushToTalkMicInput(connection: Connection, sendValue: Boolean? = null) {
    try {
...
internal fun sendRequestMiniStateThumbnail(connection: Connection, stateID: String) {
    try {
        connection.send(
...
internal fun sendRequestMiniStartListener(connection: Connection) {
    try {
        connection.send(
...
internal fun sendRequestMiniStopListener(connection: Connection) {
    try {
        connection.send(
 ...
 *
 */
internal fun sendRequestChangeBooleanNode(connection: Connection, nodeId: String, change: PayloadEvent) {
    try {
 ...
 *
 */
internal fun sendRequestSetBooleanNode(connection: Connection, nodeId: String, sendValue: Boolean) {
    try {
        val pushToTalk = VeadoRequest.createRequestWithPayload(
            event = MessageEvent.PAYLOAD, type = MessagePayloadType.BOOLEAN, id = nodeId,
            payloadEvent = PayloadEvent.SET, payloadValue = sendValue
...
internal fun sendRequestToggleBooleanNode(connection: Connection, nodeId: String) {
    try {
        val pushToTalk = VeadoRequest.createRequestWithPayload(
            event = MessageEvent.PAYLOAD, type = MessagePayloadType.BOOLEAN, id = nodeId,
...
internal fun sendRequestFullStateThumbnail(connection: Connection, nodeId: String, stateID: String) {
    try {
        connection.send(
...
internal fun sendRequestFullStartListener(
    connection: Connection, nodeType: String, nodeId: String
) {
    try {
        connection.send(
...
internal fun sendRequestFullStopListener(connection: Connection, nodeType: String, nodeId: String) {
    try {
        connection.send(
...
internal fun sendRequestFullStateList(connection: Connection, nodeId: String, nodeType: String = "stateEvents") {
    try {
        connection.send(
            channel = CHANNEL_NODES, requestData = RequestMessageNodeEvent(
                event = MessageEvent.PAYLOAD.formattedName, type = nodeType, id = nodeId,
...
internal fun sendRequestFullStatePeek(connection: Connection, nodeType: String, nodeId: String) {
    try {
        connection.send(
            channel = CHANNEL_NODES,
            RequestMessageNodeEvent(
...
internal fun sendRequestMiniStateList(connection: Connection, nodeId: String, nodeType: String = "stateEvents") {
    try {
        connection.send(
            channel = CHANNEL_NODES, requestData = RequestMessageNodeEvent(
                event = MessageEvent.PAYLOAD.formattedName, type = nodeType, id = nodeId,
...
internal fun sendRequestMiniStatePeek(connection: Connection, nodeType: String, nodeId: String) {
    try {
        connection.send(
            channel = CHANNEL_NODES,
            RequestMessageNodeEvent(
